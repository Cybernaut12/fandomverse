...
export const ProfileView: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'activity' | 'lists' | 'favorites' | 'reviews'>('activity');
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-4 -mt-16 sm:-mt-20 mb-4">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end space-y-3 sm:space-y-0 sm:space-x-5 text-center sm:text-left">
              <img
                ...
                className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl object-cover ring-4 ring-[#0e1018] shadow-2xl relative z-10"
              />
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl glass-panel hover:bg-white/10 text-slate-200 text-xs font-semibold border border-white/10 transition-all flex items-center space-x-2"
            >
      ...
      {activeTab === 'activity' && (
        <div className="space-y-4">
          {[
            ...
            <div key={act.id} className="p-4 rounded-xl glass-card border border-white/10 space-y-2">
              ...
              {act.comment && (
                <p className="text-xs text-slate-300 pl-3 border-l border-cyan-400/60 italic">
                  "{act.comment}"
                </p>
              )}
            </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {favoriteMedia.map(item => (
            <div
              ...
              className="p-3 rounded-xl glass-card border border-white/10 hover:border-cyan-400/50 cursor-pointer space-y-2 transition-all hover:scale-105"
            >
