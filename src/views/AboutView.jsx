...
import { Code, Layers, Cpu, Database, CheckCircle } from 'lucide-react';
...
export const AboutView = () => {
    ...
    return (<div className="space-y-12 pb-16 animate-in fade-in duration-200">
      ...
      <div className="p-6 sm:p-8 rounded-2xl glass-card border border-white/10 space-y-4">
        ...
        ].map((item, idx) => (<div key={idx} className="flex items-center space-x-2 text-slate-300">
      ...
      <div className="p-6 rounded-2xl glass-panel border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
        ...
        <button onClick={() => setCurrentView('discover')} className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-semibold shadow-md transition-all">
