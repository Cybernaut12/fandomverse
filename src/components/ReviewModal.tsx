...
export const ReviewModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div 
        className="relative w-full max-w-lg rounded-2xl glass-panel border border-white/10 shadow-2xl p-6 text-slate-200 space-y-5"
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-xl bg-black/40 border border-white/10 text-white focus:outline-none focus:border-cyan-400"
            >
              {mediaList.map(item => (
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder="e.g. A masterclass in atmosphere and character depth"
              className="w-full px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-cyan-400"
              required
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              placeholder="What made this world stand out? How were the performances, lore, animation, or music?"
              className="w-full px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-cyan-400 leading-relaxed"
              required
            />
          </div>

          {submitted && (
            <div className="p-2.5 rounded-lg bg-emerald-500/20 border border-emerald-500/30 text-emerald-300 text-xs font-medium flex items-center space-x-2">
