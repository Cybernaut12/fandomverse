...
import { Heart, Shield, Globe, Award, Share2, MessageCircle } from 'lucide-react';
...
export const Footer = () => {
    ...
    return (<footer className="w-full bg-[#06070a] border-t border-white/[0.08] text-slate-400 mt-20 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              {categories.map(({ label, cat }) => (<li key={cat}>
                  <button onClick={() => navigateToCategory(cat)} className="hover:text-cyan-400 transition-colors">
                    {label}
                  </button>
                </li>))}
            </ul>
